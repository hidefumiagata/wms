...
| 項目ID | 項目名 | 種別 | 必須 | 初期値 | バリデーション | 備考 |
|--------|--------|------|:----:|--------|--------------|------|
| MST022-F01 | 倉庫コード | テキスト | ○ | 空 | 必須、英大文字4文字固定（`^[A-Z]{4}$`）、一意チェック | 登録後変更不可 |
| MST022-F02 | 倉庫名 | テキスト | ○ | 空 | 必須、最大200文字 | |
| MST022-F03 | 倉庫名カナ | テキスト | ○ | 空 | 必須、最大200文字、全角カナ | |
| MST022-F04 | 住所 | テキスト | — | 空 | 最大500文字 | |
...
| `MSG-E-MST022-002` | エラー | 倉庫コード形式エラー | 倉庫コードは英大文字4文字で入力してください |
...
| MST023-F04 | 住所 | テキスト | — | 取得値 | 最大500文字 | |
