...
public class InventoryReportService {
    ...
    public ResponseEntity<List<InventoryReportItem>> generate(
        ...
        List<InventoryReportRow> rows = inventoryReportRepository.findInventoryReportData(
    ...
    private InventoryReportItem toReportItem(InventoryReportRow row) {
        int quantity = row.getQuantity();
        int allocatedQty = row.getAllocatedQty();

        InventoryReportItem item = new InventoryReportItem();
        item.setLocationCode(row.getLocationCode());
        item.setBuildingName(row.getBuildingName());
