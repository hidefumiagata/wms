...
public interface StocktakeReportRepository extends JpaRepository<StocktakeLine, Long> {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<StocktakeListRow> findStocktakeListByStocktakeId(@Param("stocktakeId") Long stocktakeId);
    ...
    @Query(value = """
            SELECT l.location_code, a.area_name, p.product_code, p.product_name,
                   ...
                   i.quantity AS system_quantity, CAST(NULL AS INTEGER) AS actual_quantity
            FROM inventories i
            ...
            """, nativeQuery = true)
    List<StocktakeListRow> findStocktakeListByBuildingId(
    ...
    @Query(value = """
            ...
            ORDER BY sl.location_code ASC, sl.product_code ASC
            """, nativeQuery = true)
    List<StocktakeResultRow> findStocktakeResultByStocktakeId(@Param("stocktakeId") Long stocktakeId);
}
