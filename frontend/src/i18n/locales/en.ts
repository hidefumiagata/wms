export default {
  ...
  outbound: {
    slip: {
      ...
      productNotFound: 'Product code "{code}" does not exist',
      createSuccess: 'Order created (Slip No: {slipNo})',
      cancelFormMessage: 'Your input will be discarded. Are you sure?',
      validation: {
        plannedDateRequired: 'Planned ship date is required',
        plannedDateTooEarly: 'Planned date must be on or after the current business date',
        partnerRequired: 'Customer is required',
        transferWarehouseRequired: 'Transfer warehouse is required',
        productRequired: 'Product code is required',
        qtyRequired: 'Quantity must be 1 or more',
        minOneLine: 'At least one line is required',
        duplicateProduct: 'Duplicate product in lines',
        hasErrors: 'Please fix the errors before submitting',
      },
    },
    picking: {
      title: 'Picking Instructions',
      instructionNumber: 'Instruction No',
      status: 'Status',
      ...
      linePending: 'Pending',
      backToList: 'Back to List',
      completeButton: 'Complete Picking',
      completeSuccess: 'Picking completed',
    },
    inspect: {
    ...
    ship: {
      ...
      confirmShipMessage: 'Confirm shipment. Allocated inventory will be deducted. Are you sure?',
