export default {
  ...
  inbound: {
    slip: {
      ...
      createSuccess: 'Inbound slip created (Slip No: {slipNo})',
      cancelFormMessage: 'Your input will be discarded. Are you sure?',
      validation: {
        plannedDateRequired: 'Planned date is required',
        partnerRequired: 'Supplier is required',
        productRequired: 'Product code is required',
        qtyRequired: 'Quantity must be 1 or more',
        lotRequired: 'Lot number is required for lot-managed products',
        expiryRequired: 'Expiry date is required for expiry-managed products',
        plannedDateTooEarly: 'Planned date must be on or after the current business date',
        expiryDateTooEarly: 'Expiry date must be on or after the current business date',
        minOneLine: 'At least one inbound line is required',
        duplicateProduct: 'Duplicate product in lines. Please consolidate',
  ...
  store: {
    ...
    confirmAll: 'Store all unstored lines. Are you sure?',
    locationRequired: 'Please select a store location',
    allStoredSuccess: 'All lines stored successfully',
    partialSuccess: 'Line stored successfully',
  },
  error: {
