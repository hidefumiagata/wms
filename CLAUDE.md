...
6. PRに対して以下の3種類のレビューを実施し、結果をPRコメントに追記する
   ...
   - **設計準拠レビュー**: `docs/architecture-design/` および `docs/test-specifications/` 配下の全ファイルをコンテキストに入れたサブエージェントが、PRの変更差分が設計書の技術方針・規約に準拠しているかをチェックする。チェック観点の例:
